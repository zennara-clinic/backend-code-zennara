...
function enabled() {
  // Zenoti is permanently authoritative for shifts, leave and block-outs.
  // Local schedule publication is disabled even if an old deployment still
  // carries ZENOTI_PUBLISH_DOCTOR_HOURS=true.
  return false;
}
