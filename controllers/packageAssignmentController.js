      ...
      assignment.sessions = updates.sessions
        ...
        .map(s => {
          ...
          return {
            ...
            specialistId: s.specialistId !== undefined ? s.specialistId : (existing && existing.specialistId) || null,
            specialistName: s.specialistName !== undefined ? s.specialistName : (existing && existing.specialistName) || null,
            specialistTier: s.specialistTier !== undefined ? s.specialistTier : (existing && existing.specialistTier) || null,
